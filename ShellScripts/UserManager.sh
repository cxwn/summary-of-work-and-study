...
echo "TMOUT=300">>/home/$AdUser/.bashrc
sleep 2
done
#Create SuperUser
...
echo "TMOUT=300">>/home/$SuperUser/.bashrc
sleep 2
done
...
echo "TMOUT=300">>/home/$DepUser/.bashrc
sleep 2
done
...
echo "TMOUT=300">>/home/$User/.bashrc
sleep 2
done
#以下内容为SUDO权限控制部分-----------
